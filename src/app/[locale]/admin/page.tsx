...
import { Users, Search, Edit, Crown, Star } from 'lucide-react';
              ...
              <tbody className="divide-y">
                {filteredUsers.map((user) => (
                  <tr key={user.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2 py-1 text-xs font-semibold rounded-full ${
                        user.status === 'public' ? 'bg-green-100 text-green-800' :
                    ...
                    <td className="px-6 py-4">
                      <button onClick={() => setEditModalUser(user)} className="text-purple-600 hover:text-purple-900">
