      ...
      <div className="w-full max-w-[1920px] px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mb-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-linear-to-r from-slate-900 via-purple-800 to-slate-900 bg-clip-text text-transparent">
              ✨ Featured Profiles
            </h2>
          </div>
        ...
        >
          ...
          {canScroll && (
            <>
              <button
                onClick={handlePrev}
                className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-linear-to-br from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white p-2 sm:p-2.5 rounded-full transition-all duration-300 opacity-70 hover:opacity-100 z-30 shadow-md"
              ...
              <button
                onClick={handleNext}
                className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-linear-to-br from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white p-2 sm:p-2.5 rounded-full transition-all duration-300 opacity-70 hover:opacity-100 z-30 shadow-md"
        ...
        <div className="flex justify-center items-center gap-3 mt-6 sm:mt-8">
          ...
          <div className="flex gap-2 bg-slate-100 px-4 py-3 rounded-full shadow-md border border-slate-200">
            {Array.from({ length: maxIndex + 1 }).map((_, index) => (
              <button
                ...
                className={`transition-all duration-300 rounded-full w-2.5 h-2.5 ${
                  index === currentIndex
                    ? 'bg-purple-600'
          ...
          <button
            ...
            className="bg-purple-600 hover:bg-purple-700 text-white p-2.5 rounded-full transition-all duration-300 shadow-md border border-purple-500 flex items-center justify-center"
